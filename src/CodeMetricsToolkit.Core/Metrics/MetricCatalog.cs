...
public static class MetricCatalog
{
    ...
    [
        ...
        new("diagnostic_count", "1.0.0", ["file", "type", "member"], "syntax/semantic", "count", "number of diagnostics whose span overlaps the target", "Counts syntax, compiler, nullable and analyzer diagnostics for source-linked targets.", ["Project-load diagnostics without source spans are emitted in diagnostics.ndjson but not attributed to source targets."]),
        new("hotspot_rank", "1.0.0", ["file", "type", "member"], "derived", "rank", "weighted percentile rank over target-kind-specific component metrics", "Explainable ranking for top-N autoresearch targets.", ["Ranking is prioritization, not a proof of code quality."])
    ];
